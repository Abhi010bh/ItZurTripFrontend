  ...
  return (
    <>
      ...
      <div className="travel p-2">
        <h1
          className="text-8xl  font-bolder subpixel-antialiased tracking-tighter"
          style={{ fontFamily: "Open Sans", color: "#0c0a09" }}
        >
          {" "}
          your trips{" "}
        </h1>
        <div
          style={{ height: "100vh" }}
          className="mt-0 travelGlass rounded-xl   grid grid-cols-1 md:grid-cols-4 gap-2"
        >

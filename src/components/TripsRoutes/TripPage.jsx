    ...
    <div className="travel p-2 h-screen" style={{ fontFamily: 'Open Sans' }}>
      <div className="grid grid-cols-3 gap-5">
        ...
        <div className="col-span-2 p-24 pl-48">
          <Box sx={{ display: 'flex', flexWrap: 'wrap', '& > :not(style)': { m: 0, width: 1024, height: 512 } }}>
            <Paper elevation={3}>
          ...
          <div className="p-5 flex flex-col justify-center items-center">
            <Box sx={{ display: 'flex', flexWrap: 'no-wrap', gap: 5, '& > :not(style)': { m: 0, width: 104, height: 96 } }}>
              <Paper elevation={3} className="mx-5 text-white font-bold bg-red-500 flex flex-col justify-center items-center">Bookings</Paper>
              <Paper elevation={3} onClick={handleClick} className="text-white font-bold bg-green-400 flex flex-col justify-center items-center">Expenses</Paper>
              <Paper elevation={3} className="text-white font-bold bg-orange-500 flex flex-col justify-center items-center">Gallery</Paper>
            </Box>
          </div>
        </div>
      </div>
